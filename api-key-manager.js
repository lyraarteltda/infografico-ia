...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'infografico-ia_apikey_';
  ...
  const ENABLED_SERVICES = ['openrouter','openai']; // openrouter,openai
  ...
  // Refreshed from the LIVE OpenRouter ranking on 2026-07-29 (Hard Rule #19).
  const AI_MODELS = {
    claude: {
    ...
    openai: {
      ...
      models: [
        ...
        { id: 'openai/gpt-5.4-nano', name: 'GPT-5.4 Nano — econômico' }
      ]
    },
    google: {
      label: 'Google (Gemini)',
    ...
    gratis: {
      label: 'Grátis (sem crédito na chave)',
      models: [
